...
import { useState, useEffect } from "react"
import { useParams } from "next/navigation"
import ResetPasswordSetupPage from "@/components/auth/reset-password-setup-page"
...
export default function PasswordVerificationPage() {
  ...
  return <ResetPasswordSetupPage email={email} toggleTheme={toggleTheme} isDark={isDark} token={token} />
}
