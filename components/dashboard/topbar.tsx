...
//       {/* Middle Section - Organization Selector */}
//       <div className="relative hidden md:block">
//         <button
//           onClick={() => setShowOrgSelector(!showOrgSelector)}
//           className="flex items-center gap-2 px-4 py-2 bg-muted hover:bg-muted/80 rounded-lg transition-colors duration-200 border border-border"
//         >
